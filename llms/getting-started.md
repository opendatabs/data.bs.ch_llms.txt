...
- [ODSQL cheat sheet](https://data.bs.ch/llms/odsql-cheatsheet.md)
- [Query cookbook](https://data.bs.ch/llms/query-cookbook.md)
- [Dataset index](https://data.bs.ch/llms/datasets/index.md)
